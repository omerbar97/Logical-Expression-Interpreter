...
public class Xnor extends BinaryExpression {
     ...
     * @param v2 - Expression.
     */
    public Xnor(Expression v1, Expression v2) {
        super(v1, v2);
    }
    ...
    public Expression norify() {
        return new Nor((new Nor(super.getV1().norify(), new Nor(super.getV1().norify(), super.getV2().norify()))),
                (new Nor(super.getV2().norify(), new Nor(super.getV1().norify(), super.getV2().norify()))));
    }
