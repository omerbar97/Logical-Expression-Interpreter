...
public class Or extends BinaryExpression {
     ...
     * @param v2 - Expression.
     */
    public Or(Expression v1, Expression v2) {
        super(v1, v2);
    }
    ...
    public Expression nandify() {
        return new Nand((new Nand(super.getV1().nandify(), super.getV1().nandify())),
                (new Nand(super.getV2().nandify(), super.getV2().nandify())));
    }

    @Override
    public Expression norify() {
        return new Nor((new Nor(super.getV1().norify(), super.getV2().norify())),
    ...
    public Expression simplify() {
        ...
        if (e1.simplify().toString().equals("T") || (getV2().simplify().toString().equals("T"))) {
            // one of the expression is true need to return true, true | x = true
            return new Val(true);
        }
